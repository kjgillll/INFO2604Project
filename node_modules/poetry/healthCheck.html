  ...
  <body>
    ...
    <script type="text/javascript">
      ...
      try{
        ...
        request.open("GET", '/_healthCheck/'+SERVICE, false);
        ...
        return function(){
          ...
          if(data.knownServices)
            data.knownServices.forEach(function(serv){
              ...
              try{
                var request = new XMLHttpRequest();
                request.open("GET", '/_healthCheck/'+serv, false);
      ...
      function draw(){
        ...
        Object.keys(services)
          ...
          .forEach(function(serv){
            ...
            serviceName.title = '/_healthCheck/'+serv;
            ...
            if(typeof services[serv] == 'string'){
              ...
              date = new Date( 2000+date[0], 0, 2000+date[1]).getTime();
              date = Date.now() - date;
